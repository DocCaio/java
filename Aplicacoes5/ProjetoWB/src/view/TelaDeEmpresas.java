...
public class TelaDeEmpresas {
	...
	protected Shell shlTelaDeEmpresas;
	private Table table;
	...
	public void open() {
		...
		createContents();
		shlTelaDeEmpresas.open();
		shlTelaDeEmpresas.layout();
		while (!shlTelaDeEmpresas.isDisposed()) {
	...
	protected void createContents() {
		shlTelaDeEmpresas = new Shell();
		shlTelaDeEmpresas.setSize(604, 393);
		shlTelaDeEmpresas.setText("Tela de Empresas");
		
		table = new Table(shlTelaDeEmpresas, SWT.BORDER | SWT.FULL_SELECTION);
		...
		table.setHeaderForeground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
		table.setHeaderBackground(SWTResourceManager.getColor(SWT.COLOR_WIDGET_DARK_SHADOW));
		...
		Label labelCodigo = new Label(shlTelaDeEmpresas, SWT.NONE);
		labelCodigo.setText("C\u00F3digo");
		labelCodigo.setBounds(10, 181, 55, 15);
		
		textCodigo = new Text(shlTelaDeEmpresas, SWT.BORDER);
		textCodigo.setEditable(false);
		textCodigo.setBounds(98, 178, 76, 21);
		
		Label labelNome = new Label(shlTelaDeEmpresas, SWT.NONE);
		labelNome.setText("Nome empresa:");
		labelNome.setBounds(10, 208, 83, 15);
		
		textNome = new Text(shlTelaDeEmpresas, SWT.BORDER);
		textNome.setBounds(98, 205, 205, 21);
		
		Label labelEndereco = new Label(shlTelaDeEmpresas, SWT.NONE);
		labelEndereco.setText("Endere\u00E7o:");
		labelEndereco.setBounds(10, 232, 83, 15);
		
		textEndereco = new Text(shlTelaDeEmpresas, SWT.BORDER);
		textEndereco.setBounds(98, 229, 205, 21);
		
		Label labelTelefone = new Label(shlTelaDeEmpresas, SWT.NONE);
		labelTelefone.setText("Telefone:");
		labelTelefone.setBounds(10, 256, 83, 15);
		
		textTelefone = new Text(shlTelaDeEmpresas, SWT.BORDER);
		textTelefone.setBounds(98, 253, 205, 21);
		
		btnSalvar = new Button(shlTelaDeEmpresas, SWT.NONE);
		btnSalvar.setEnabled(false);
		...
		btnExcluir = new Button(shlTelaDeEmpresas, SWT.NONE);
		...
		Button btnIncluir = new Button(shlTelaDeEmpresas, SWT.NONE);
