...
public class TelaDeFuncionarios {
	...
	protected void createContents() {
		...
		tableEmpresas.setHeaderForeground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
		tableEmpresas.setHeaderBackground(SWTResourceManager.getColor(SWT.COLOR_WIDGET_DARK_SHADOW));
		...
		btnExcluir.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				preencherGridFuncionarios( funcionario.getEmpresa().getCodigo() );
			}
		});
		...
		tableFuncionarios.setHeaderForeground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
		tableFuncionarios.setHeaderBackground(SWTResourceManager.getColor(SWT.COLOR_WIDGET_DARK_SHADOW));
		...
		labelTitulo.setForeground(SWTResourceManager.getColor(SWT.COLOR_BLUE));
		labelTitulo.setFont(SWTResourceManager.getFont("Segoe UI", 9, SWT.BOLD));
